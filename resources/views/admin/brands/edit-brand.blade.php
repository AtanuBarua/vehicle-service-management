                        ...
                        <div class="mg-b-25">
                            <div class=" row col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input required class="form-control" type="text" name="name" value="{{$brand->name}}">
                            ...
                            <div class="row col-lg-4 mt-3">
                                <div class="form-group mg-b-10-force">
                                    ...
                                    <div class="col-md-9 radio">
                                        <label>  <input required type="radio" {{$brand->status==1 ? 'checked' : '' }} name="status" value="1"> Active </label>
                                        <label>  <input required type="radio" {{$brand->status==0 ? 'checked' : '' }} name="status" value="0"> Inactive </label>
                                    </div>
