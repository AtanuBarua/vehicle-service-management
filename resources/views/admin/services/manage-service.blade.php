        ...
        <div class="card pd-20 pd-sm-40">
            ...
            <div class="table-wrapper">
                <div class="sl-page-title d-flex justify-content-end">
                    <a type="button" href="{{route('add-service')}}" class="btn btn-success">Add Service</a>
                </div>
                <table id="datatable1" class="table display responsive nowrap">
                    ...
                    @foreach($services as $service)
                        <tr>
                            ...
                            <td>
                                <a title="Edit" href="{{route('edit-service',['id'=>$service->id])}}"  class="btn btn-sm btn-primary"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                ...
                                <form id="deleteProductForm{{$service->id}}" action="{{route('delete-service')}}" method="post">
                                    @csrf
