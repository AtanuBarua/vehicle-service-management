...
<div class="sl-sideleft">
    ...
    <div class="sl-sideleft-menu">
        ...
        <a href="{{route('manage-city')}}" class="sl-menu-link">
            <div class="sl-menu-item">
        ...
        <a href="{{route('manage-orders')}}" class="sl-menu-link">
            <div class="sl-menu-item">
                <i class="menu-item-icon icon ion-ios-photos-outline tx-20"></i>
        ...
        <a href="{{route('manage-services')}}" class="sl-menu-link">
            <div class="sl-menu-item">
                <i class="menu-item-icon icon ion-ios-photos-outline tx-20"></i>
        ...
        <a href="{{route('manage-bookings')}}" class="sl-menu-link">
            <div class="sl-menu-item">
                <i class="menu-item-icon icon ion-ios-photos-outline tx-20"></i>
        ...
        <a href="{{route('manage-technicians')}}" class="sl-menu-link">
            <div class="sl-menu-item">
                <i class="menu-item-icon icon ion-ios-photos-outline tx-20"></i>
