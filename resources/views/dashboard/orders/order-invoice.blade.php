  ...
  <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    <tr>
        <td valign="top">
          ...
          <br><br>
          <img src="{{public_path('assets/front/images/menu/logo/1.png')}}" height="80" width="100" alt="Uren's Logo">
        </td>
        <td align="right">
            <pre class="font" >
               Uren Head Office <br>
    ...
    <tr>
        <td>
          <p class="font" style="margin-left: 20px;">
           ...
           <strong>Address:</strong> {{ $order->address }},{{ $order->city_name }},{{ $order->region_name }} <br>
         </p>
        </td>
        <!-- <td>
          <p class="font">
