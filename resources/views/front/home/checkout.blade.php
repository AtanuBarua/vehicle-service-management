                            ...
                            <div class="card" style="width: 20rem;">
                                <div class="card-body">
                                    ...
                                    <button data-id="{{$item->id}}" type="button"
                                        class="btn btn-sm btn-primary mt-3 openSecondModalBtn" id="openSecondModalBtn">
                                        Edit
                                    </button>
                                </div>
                            </div>
                ...
                <div class="modal-body">
                    <div class="checkbox-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="checkout-form-list">
                                    <input type="checkbox" name="default_shipping_address" id="default_shipping_address"
                            ...
                            <div class="col-md-12">
                                <div class="checkout-form-list">
                                    <input type="checkbox" name="default_billing_address" id="default_billing_address"
                                        placeholder="" type="text">
